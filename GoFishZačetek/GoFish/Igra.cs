...
namespace GoFish
{
    class Igra
    {
        ...
        { Random r = new Random();
            ...
            kompleti = new Dictionary<Vrednosti, Igralec>(); talon = new Kup();
            //ne pozabi, če kličem brez parametrov 
        ...
        private void Deli() { 
            ...
            foreach (Igralec ig in igralci) 
                IzločiKomplete(ig); //naprej napisana metoda 
        } 
        public bool IgrajEnKrog(int izbranaKarta)
            { 
            //metoda vrač true, če je konec igre, false sicer 
    ...
    foreach (string name in winners.Keys) 
        ...
        { winnerList += " in "; 
            ...
            if (tie) return "Neodločeno " + winnerList; else return winnerList;
}
